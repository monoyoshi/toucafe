            ...
            <section style={{padding: "64px 0"}}>
                <div className="row center">
                    ...
                    <div className="column-45">
                        ...
                        <p className="br-bottom">From the depths of the infinite void, rises another strange and seemingly random project... muahaha... MWAHAHAH—</p>
                        <p className="br-bottom">Driven by a desire to collect recipes to fill the <Link href="/about">SFK</Link>-shaped hole in my heart, tou café fuses art, code, and food into a website that looks like a modern coffee shop, but is actually a database for cool recipes that my girlfriend and I found.</p>
