...
import { HRBreak, NavbarHeader, ContentFooter } from "/app/layout.js";
...
export default function Home() {
    return (
        <>
            <NavbarHeader currentPage="about" />
                    ...
                    <section style={{padding: "32px 0 32px"}}>
                        <div className="row center">
                            <div className="column-35 center">
                                <div className="hfont h1">the next step (:smirk:)</div>
                                <div className="hfont h3 br-bottom">if tou café is so good, where's tou café 2?</div>
                                <p className="br-bottom">This project was made with Next.js by Vercel (so, React.js).</p>
                                ...
                                <p>As for <Link href="https://tou-cafe.bladewyrm.dev/" target="_blank" rel="noopener noreferrer">the original site</Link>, it will still be maintained with new recipes, though updates might be a little slower.</p>
                            </div>
