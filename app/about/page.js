                    ...
                    <section style={{padding: "32px 0 32px"}}>
                        <div className="row center">
                            <div className="column-35 center">
                                ...
                                <p>As for <Link href="https://tou-cafe.bladewyrm.dev/" target="_blank" rel="noopener noreferrer">the original site</Link>, it will still be maintained with new recipes, but updates might be a little slower.</p>
                            </div>
